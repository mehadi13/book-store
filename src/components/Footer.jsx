      ...
      <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-md">
          <strong className="block text-center text-xl font-bold text-gray-900 sm:text-3xl">
            Want us to email you with the latest published books?
          </strong>
        ...
        <ul className="mt-12 flex flex-wrap justify-center gap-6 md:gap-8 lg:gap-12">
          ...
          <li>
            <Link className="text-gray-700 transition hover:text-gray-700/75" to="/blog"> Blog </Link>
          </li>

          <li>
            <Link className="text-gray-700 transition hover:text-gray-700/75" to="/faq"> FAQ </Link>
          </li>
        </ul>
        ...
        <div className="mt-16 border-t border-gray-100 pt-8">
          <p className="text-center text-xs/relaxed text-gray-500">
            © BookNook 2024. All rights reserved.

            <br />

            Created with
            <a href="https://react.dev/" className="text-gray-700 underline transition hover:text-gray-700/75">React</a>
            and
            <a href="https://tailwindcss.com/" className="text-gray-700 underline transition hover:text-gray-700/75"
            >TailwidnCSS</a>.
          </p>
        </div>
      </div>
